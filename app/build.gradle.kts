...
tasks.register<JacocoReport>("jacocoTestReport") {
    ...
    val excludes = listOf(
        ...
        "**/data/local/db/**",
        "**/data/local/entity/**",
        "**/data/repository/Firebase*RepositoryImpl*.*",
        "**/data/repository/GitLive*Repository*.*",
        "**/data/repository/*RepositoryImpl*.*",
        "**/data/repository/Unified*Repository*.*",
        "**/data/local/datastore/**",
        "**/data/local/sync/**",
        "**/domain/service/FirebaseInitializerService*.*",
        "**/domain/service/InventorySyncService*.*",
